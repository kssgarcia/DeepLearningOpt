...
model.load_weights('./training_temp')

# Load your new data for continuation of training
# x_new_train, y_new_train = load_new_data()

# Continue training with the new data
model.fit(input_data, output, epochs=10, batch_size=1, callbacks=[model_checkpoint_callback])