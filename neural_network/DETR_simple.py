...
plt.ylabel('Loss')
plt.legend()
plt.savefig('plots/loss_matlab_detr.png')  # Save the plot as an image
plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('plots/accuracy_matlab_detr.png')  # Save the plot as an image
plt.show()
