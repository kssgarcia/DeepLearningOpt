...
class SwinEmbedding(nn.Module):
    def __init__(self, patch_size: int=3, emb_size: int=96):
        super().__init__()
...
class ShiftedWindowMSA(nn.Module):
    def __init__(self, emb_size: int, num_heads: int, window_size: int=7, shifted: bool=True):
        super().__init__()
...
class SwinEncoder(nn.Module):
    def __init__(self, emb_size: int, num_heads: int, window_size: int=6):
        super().__init__()
