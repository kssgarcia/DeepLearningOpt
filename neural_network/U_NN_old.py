...
plt.ylabel('Loss')
plt.legend()
plt.savefig('plots/loss_matlab_unn.png')  # Save the plot as an image
plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('plots/accuracy_matlab_unn.png')  # Save the plot as an image
plt.show()
